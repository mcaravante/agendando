...
export const translations: Translations = {
  ...
  'footer.docs': { es: 'Documentacion', en: 'Documentation' },
  'footer.rights': { es: 'Todos los derechos reservados.', en: 'All rights reserved.' },

  // Home page
  'home.header.dashboard': { es: 'Ir al Dashboard', en: 'Go to Dashboard' },
  'home.header.signIn': { es: 'Iniciar Sesion', en: 'Sign In' },
  'home.header.signUp': { es: 'Registrarse', en: 'Sign Up' },

  'home.hero.title': { es: 'Programa reuniones sin el ida y vuelta', en: 'Schedule meetings without the back and forth' },
  'home.hero.subtitle': { es: 'Comparte tu disponibilidad y deja que otros reserven tiempo contigo. Simple, rapido y profesional.', en: 'Share your availability and let others book time with you. Simple, fast and professional.' },
  'home.hero.cta': { es: 'Comenzar gratis', en: 'Get started free' },
  'home.hero.secondary': { es: 'Ver documentacion', en: 'View documentation' },

  'home.features.title': { es: 'Todo lo que necesitas para gestionar tu agenda', en: 'Everything you need to manage your schedule' },
  'home.features.subtitle': { es: 'Herramientas potentes para simplificar tu dia a dia', en: 'Powerful tools to simplify your day-to-day' },
  'home.features.availability.title': { es: 'Disponibilidad inteligente', en: 'Smart availability' },
  'home.features.availability.desc': { es: 'Define tus horarios por dia, agrega buffers entre reuniones y bloquea fechas especificas.', en: 'Set your hours by day, add buffers between meetings and block specific dates.' },
  'home.features.eventTypes.title': { es: 'Tipos de eventos', en: 'Event types' },
  'home.features.eventTypes.desc': { es: 'Crea distintos tipos de reunion con duracion, ubicacion y precio personalizados.', en: 'Create different meeting types with custom duration, location and pricing.' },
  'home.features.shareLink.title': { es: 'Link para compartir', en: 'Shareable link' },
  'home.features.shareLink.desc': { es: 'Comparte tu link personal y deja que otros elijan el horario que mejor les funcione.', en: 'Share your personal link and let others choose the time that works best for them.' },
  'home.features.notifications.title': { es: 'Notificaciones', en: 'Notifications' },
  'home.features.notifications.desc': { es: 'Emails automaticos de confirmacion, recordatorios y workflows personalizados.', en: 'Automatic confirmation emails, reminders and custom workflows.' },

  'home.howItWorks.title': { es: 'Como funciona', en: 'How it works' },
  'home.howItWorks.subtitle': { es: 'Tres pasos para empezar a recibir reservas', en: 'Three steps to start receiving bookings' },
  'home.howItWorks.step1.title': { es: 'Configura tu agenda', en: 'Set up your schedule' },
  'home.howItWorks.step1.desc': { es: 'Define tus horarios disponibles y crea los tipos de eventos que ofreces.', en: 'Define your available hours and create the event types you offer.' },
  'home.howItWorks.step2.title': { es: 'Comparte tu link', en: 'Share your link' },
  'home.howItWorks.step2.desc': { es: 'Envia tu link personalizado por email, redes sociales o insertalo en tu web.', en: 'Send your custom link via email, social media or embed it on your website.' },
  'home.howItWorks.step3.title': { es: 'Recibe reservas', en: 'Receive bookings' },
  'home.howItWorks.step3.desc': { es: 'Tus invitados eligen un horario y ambos reciben la confirmacion al instante.', en: 'Your guests choose a time and both of you receive instant confirmation.' },

  'home.pricing.title': { es: 'Planes simples y transparentes', en: 'Simple, transparent pricing' },
  'home.pricing.subtitle': { es: 'Empieza gratis, escala cuando lo necesites', en: 'Start free, scale when you need to' },
  'home.pricing.month': { es: '/mes', en: '/month' },
  'home.pricing.free.name': { es: 'Gratis', en: 'Free' },
  'home.pricing.free.description': { es: 'Para individuos que estan empezando', en: 'For individuals just getting started' },
  'home.pricing.free.cta': { es: 'Comenzar gratis', en: 'Get started free' },
  'home.pricing.free.f1': { es: 'Tipos de eventos ilimitados', en: 'Unlimited event types' },
  'home.pricing.free.f2': { es: 'Pagina de reservas personalizable', en: 'Customizable booking page' },
  'home.pricing.free.f3': { es: 'Notificaciones por email', en: 'Email notifications' },
  'home.pricing.free.f4': { es: 'Integraciones con Google y Zoom', en: 'Google & Zoom integrations' },
  'home.pricing.pro.name': { es: 'Pro', en: 'Pro' },
  'home.pricing.pro.description': { es: 'Para profesionales y equipos', en: 'For professionals and teams' },
  'home.pricing.pro.badge': { es: 'Recomendado', en: 'Recommended' },
  'home.pricing.pro.cta': { es: 'Comenzar prueba gratis', en: 'Start free trial' },
  'home.pricing.pro.f1': { es: 'Todo lo del plan Gratis', en: 'Everything in Free' },
  'home.pricing.pro.f2': { es: 'Workflows avanzados', en: 'Advanced workflows' },
  'home.pricing.pro.f3': { es: 'Cobro de pagos con MercadoPago', en: 'Payment collection with MercadoPago' },
  'home.pricing.pro.f4': { es: 'Analitica detallada', en: 'Detailed analytics' },
  'home.pricing.pro.f5': { es: 'Branding personalizado', en: 'Custom branding' },

  'home.cta.title': { es: 'Listo para simplificar tu agenda?', en: 'Ready to simplify your schedule?' },
  'home.cta.subtitle': { es: 'Unete a miles de profesionales que ya usan Agendando para gestionar sus reuniones.', en: 'Join thousands of professionals already using Agendando to manage their meetings.' },
  'home.cta.button': { es: 'Crear cuenta gratis', en: 'Create free account' },

  'home.hero.badge': { es: 'Agenda tu tiempo de forma inteligente', en: 'Schedule your time, intelligently' },
  'home.hero.mockup.confirmed': { es: 'Reserva confirmada', en: 'Booking confirmed' },
  'home.hero.mockup.reminder': { es: 'Recordatorio enviado', en: 'Reminder sent' },
  'home.features.label': { es: 'Funcionalidades', en: 'Features' },
  'home.howItWorks.label': { es: 'Proceso', en: 'Process' },
  'home.pricing.label': { es: 'Precios', en: 'Pricing' },
